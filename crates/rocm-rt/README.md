...
This API is very limited and only covers a small subset of HIP and hipRTC, but no Linear Algebra libraries (hipBLAS, rocFFT, rocSOLVER, etc.).

The example shown below compiles and launches a simple program:
